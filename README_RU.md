...
> **Примечание**:  
Это учебный проект, направленный на демонстрацию современных методов компьютерного зрения и ускорения с помощью CUDA, а не на создание производственной системы распознавания лиц.
