...
> [!NOTE]
> **Этот репозиторий переведён в архив.** Это личный пет проект, созданный исключительно в учебных целях — он никогда не предполагал активной поддержки или использования в продакшене.
